...
def notifications(request):
    ...
    follow_notifications = follow_notifications.select_related(
        'user', 'user__profile')
    # tweet notifications
